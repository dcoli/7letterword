...
public abstract class Strategy 
{
	...
	public Strategy(KnowledgeBase kb, int totalRounds, ArrayList<String> playerList, HashMap<Character, Integer> letters)
	{
		this.kb = kb;
	 ...
	 */
	abstract public void update(Letter bidLetter, ArrayList<PlayerBids> PlayerBidList, SecretState secretstate);
	 ...
	 */
	abstract public int calculateBidAmount(Letter bidLetter);
